                        ...
                        <form id="add_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="product_id" id="product_id" class="form-control select2 m-b-10"
                                                data-allow-clear="true" placeholder="@lang('translation.Select Product')">
                                                <option></option>
                                            </select>
                            ...
                            <div class="selected-products-container mb-3 ">
                                <div class="card-header-divider mb-3">
                                    <h5 class="pb-2">@lang('translation.Selected products')</h5>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input appo_type" name="appo_type" id="appo_type_1" value="0" checked>
                                    <label class="form-check-label" for="appo_type_1">@lang('translation.AppoTypeAppointment')</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input appo_type" name="appo_type" id="appo_type_2" value="1">
                                    <label class="form-check-label" for="appo_type_2">@lang('translation.AppoTypeZoomMeeting')</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="appt_custom_box col-md-6 row">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="appo_date" class="control-label">@lang('translation.Available_Time_Slots')</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="note" class="form-control note" name="note"
                                        placeholder="@lang('translation.Enter Note')" rows="5"></textarea>
                                        <span class="invalid-feedback error-note" role="alert"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 form-footer text-end mt-3">
                                <a href="{{ route('customer.home') }}" class="btn btn-default waves-effect">@lang('translation.Cancel')</a>
                                <button type="reset" class="btn btn-primary reset-filter waves-effect reset-form">
