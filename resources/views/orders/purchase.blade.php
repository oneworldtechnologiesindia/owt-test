            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group-card-header d-flex align-items-center justify-content-between mb-4">
                        <h4 class="card-title">@lang('translation.All Purchase')</h4>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel"><span class="modal-lable-class">@lang('translation.View')</span> @lang('translation.Order')</h5>
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#customer-information" role="tab">
                                    ...
                                    <span class="d-none d-sm-block">@lang('translation.Dealer Profile')</span>
                                </a>
                            </li>
                        </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-md-4 col-sm-6">
                                                    ...
                                                    <div class="rating-star">
                                                        <input type="hidden" id="communication_rating" data-filled="mdi mdi-star text-primary" data-empty="mdi mdi-star-outline text-muted" name="communication_rating" data-fractions="2" data-input="communication"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-4 col-sm-6">
                                                    <h5 class="font-size-15">@lang('translation.Transaction')</h5>
                                                    <div class="rating-star">
                                                        <input type="hidden" id="transaction_rating" data-filled="mdi mdi-star text-primary" data-empty="mdi mdi-star-outline text-muted" name="transaction_rating" data-fractions="2" data-input="transaction"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-4 col-sm-6">
                                                    <h5 class="font-size-15">@lang('translation.Delivery')</h5>
                                                    <div class="rating-star">
                                                        <input type="hidden" id="delivery_rating" data-filled="mdi mdi-star text-primary" data-empty="mdi mdi-star-outline text-muted" name="delivery_rating" data-fractions="2" data-input="delivery" />
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('customer.purchase.list') }}";
        var deleteUrl = "{{ route('customer.sales.delete') }}";
        var addUrl = "{{ route('customer.sales.addupdate') }}";
        var addRatingUrl = "{{ route('customer.purchases.addRatingUrl') }}";
        var getOrderProductListUrl = "{{ route('customer.getOrderProductList') }}";
        var detailUrl = "{{ route('customer.getDetailOrder') }}";
        var getInvoiceUrl = "{{ route('customer.sales.getInvoice') }}";
        var notifyOrderId = "{{ isset($order_id) && !empty($order_id) ? $order_id : '' }}";
    </script>
@endsection

@section('script-bottom')
    <script src="{{ addPageJsLink('purchase.js') }}"></script>
@endsection
