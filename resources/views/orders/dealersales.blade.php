...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('dealer.sales.list') }}";
        var deleteUrl = "{{ route('dealer.sales.delete') }}";
        var addUrl = "{{ route('dealer.sales.addupdate') }}";
        var getOrderProductListUrl = "{{ route('dealer.getOrderProductList') }}";
        var detailUrl = "{{ route('dealer.getDetailOrder') }}";
        var confirmOrderPaymentUrl = "{{ route('dealer.sales.confirmOrderPayment') }}";
        var orderShippingUrl = "{{ route('dealer.sales.orderShipping') }}";
        var orderCanceledUrl = "{{ route('dealer.sales.orderCanceled') }}";
