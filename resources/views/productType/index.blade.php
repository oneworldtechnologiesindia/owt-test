...
@section('title')
     @lang('translation.Product Types')
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group-card-header d-flex align-items-center justify-content-between mb-4">
                        <h4 class="card-title">@lang('translation.All Types')</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel"><span class="modal-lable-class">@lang('translation.Add')</span> @lang('translation.Type')</h5>
                ...
                <div class="modal-body">
                    <form id="add-form" method="post" class="form-horizontal" action="#">
                        ...
                        <div class="mb-3">
                            <label for="type_name" class="control-label">@lang('translation.Type')</label>
                            <input id="type_name" type="text" class="form-control" name="type_name"
                                placeholder="@lang('translation.Enter Type')">
                            <span class="invalid-feedback" id="type_nameError" data-ajax-feedback="type_name"
                                role="alert"></span>
                        </div>
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('product-type.list') }}";
        var detailUrl = "{{ route('product-type.detail') }}";
        var deleteUrl = "{{ route('product-type.delete') }}";
        var addUrl = "{{ route('product-type.addupdate') }}";
    </script>
@endsection

@section('script-bottom')
    <script src="{{ addPageJsLink('productType.js') }}"></script>
@endsection
