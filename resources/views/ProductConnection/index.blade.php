...
@section('title')
     @lang('translation.Product Connections')
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group-card-header d-flex align-items-center justify-content-between mb-4">
                        <h4 class="card-title">@lang('translation.All Connections')</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel"><span class="modal-lable-class">@lang('translation.Add')</span> @lang('translation.Connection')
                    </h5>
                ...
                <div class="modal-body">
                    <form id="add-form" method="post" class="form-horizontal" action="#">
                        ...
                        <div class="mb-3">
                            <label for="connection_name" class="control-label">@lang('translation.Connection')</label>
                            <input id="connection_name" type="text" class="form-control" name="connection_name"
                                placeholder="@lang('translation.Enter Connection')">
                            <span class="invalid-feedback" id="connection_nameError" data-ajax-feedback="connection_name"
                                role="alert"></span>
                        </div>
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('product-connection.list') }}";
        var detailUrl = "{{ route('product-connection.detail') }}";
        var deleteUrl = "{{ route('product-connection.delete') }}";
        var addUrl = "{{ route('product-connection.addupdate') }}";
    </script>
@endsection

@section('script-bottom')
    <script src="{{ addPageJsLink('productConnection.js') }}"></script>
@endsection
