            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-form" method="post" class="form-horizontal" action="#">
                        ...
                        <div class="mb-3">
                            <label for="brand_name" class="control-label">@lang('translation.Brand')</label>
                            <input id="brand_name" type="text" class="form-control" name="brand_name"
                                placeholder="@lang('translation.Brand')">
                            <span class="invalid-feedback" id="brand_nameError" data-ajax-feedback="brand_name"
                                role="alert"></span>
                        </div>
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('brand.list') }}";
        var detailUrl = "{{ route('brand.detail') }}";
        var deleteUrl = "{{ route('brand.delete') }}";
        var addUrl = "{{ route('brand.addupdate') }}";
    </script>
@endsection

@section('script-bottom')
    <script src="{{ addPageJsLink('brand.js') }}"></script>
@endsection
