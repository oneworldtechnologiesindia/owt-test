...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('li_2')
            <a href="{{ route('customer.enquiry') }}">@lang('translation.Enquiry')</a>
        @endslot
        @slot('title')
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('customer.getDealerEnquiry') }}";
        var detailUrl = "{{ route('customer.getDetailEnquiry') }}";
        var sendOfferUrl = "{{ route('customer.sendOffer') }}";
        ...
        var getOfferProductListUrl = "{{ route('customer.getOfferProductList') }}";
        var updateOfferStatusUrl = "{{ route('customer.updateOfferStatus') }}";
        var mypurchasesUrl = "{{ route('customer.purchases') }}";
