                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Get In Touch Contact Detail Below.

                                            <p><b>Firstname</b>: {{$mail_data['name']}}</p>
                                            <p><b>Email</b>: {{$mail_data['email']}}</p>
                                            <p><b>Phone</b>: {{$mail_data['phone']}}</p>
                                            <p><b>Message</b>: {{$mail_data['message']}}</p>
                                        </p>
                                        {{-- Action Button --}}
                                        @isset($actionText)
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a target="_blank" rel="noopener noreferrer"
                                                                                ...
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">{{ $actionText }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
