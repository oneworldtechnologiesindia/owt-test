                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            @if ($user->status == 0)
                                                @lang('translation.Your data has been received! You will soon receive an email notification with the results of the account verification. Then you can login account.')
                                            @elseif($user->status == 1)
                                                @lang('translation.Congratulations, your account has been approved.')
                                            @elseif($user->status == 2)
                                                @lang('translation.Your account have been deactivated.')
                                            @endif
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
