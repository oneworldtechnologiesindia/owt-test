                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            @lang('translation.Hello') <?= $user->first_name . ' ' . $user->last_name ?>,</h1>
                                        <p
                                            ...
                                            @lang('translation.A User') <b><?= $loginUser->name ?> </b> 
                                            @lang('translation.has sent a new Purchase Enquiry').<br><br>

                                            @lang('translation.Purchase Enquiry details is given below'):
                                            <br>
                                            <br> <b>@lang('translation.Customer Name'):</b>
                                            <?= $data['first_name'] . ' ' . $data['last_name'] ?>
                                            <br> <b>@lang('translation.Customer Email'):</b> <?= $loginUser->email ?>
                                            <br>
                                            <br> <b>@lang('translation.Product Name'):</b> <?= $data['product_name'] ?>
                                            <br> <b>@lang('translation.Enquiry Description'):</b>
                                            <?= $purchaseEnquiry->enquiry_description ?>
                                            <br> <b>@lang('translation.Enquiry Type'):</b>
                                            <?= $purchaseEnquiry->enquiryTypeView($purchaseEnquiry->enquiry_type) ?>
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            @lang('translation.Disclaimer')
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} {{ config('app.name') }}. @lang('translation.All rights reserved').</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
