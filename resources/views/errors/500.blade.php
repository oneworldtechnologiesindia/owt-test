                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            ...
                            <h4 class="text-uppercase">@lang('translation.Internal Server Error')</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="index">
                                @lang('translation.Back to Dashboard')</a>
                            </div>
                        </div>
                    </div>
                </div>
