    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body" style="height: 753px;">
                            <div class="mb-4">
                                <h4 class="card-title">@lang('translation.All_Products')</h4>
                            </div>
                            <div class="product-filter-form-container mb-5">
                                <form id="filter-product-form" method="post" class="form-horizontal"
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="brand_id[]" id="brand_id"
                                                ...
                                                placeholder="@lang('translation.Select Brand')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="producttype_id[]" id="producttype_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select Type')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="productcategory_id[]" id="productcategory_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select_Category')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="product_id[]" id="product_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select Product')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="productconnection_id[]" id="productconnection_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select Connections')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="productexecution_id[]" id="productexecution_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select Execution')" multiple>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="productattributes_id[]" id="productattributes_id"
                                                class="form-control select2 select2-multiple"
                                                placeholder="@lang('translation.Select Attribute')" multiple>
