...
@section('title')
    @lang('translation.Order Payments')
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group-card-header d-flex align-items-center justify-content-between mb-4">
                        <h4 class="card-title">@lang('translation.All_Order_Payments')</h4>
                    </div>
                        ...
                        <table id="listTable" class="table align-middle table-hover table-nowrap w-100 dataTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>@lang('translation.Dealer Payout')</th>
                                    <th>@lang('translation.Site Fee')</th>
...
@section('script')
    ...
    <script>
        var apiUrl = "{{ route('dealer.purcahse-payment-log.list') }}";
        var detailUrl = "{{ route('dealer.purcahse-payment-log.detail') }}";
        var login_user_type = parseInt("{{ $loginUser->role_type }}");
        var detailUrl = "{{ route('dealer.getDetailOrder') }}";
        var getInvoiceUrl = "{{ route('dealer.sales.getInvoice') }}";
...
@section('script-bottom')
    <script src="{{ addPageJsLink('order_payment_log.js') }}"></script>
@endsection
