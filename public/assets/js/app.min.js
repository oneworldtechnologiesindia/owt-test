    ...
    function initSettings() {
        ...
        if (themeStyle != null) {
            if (themeStyle == 'dark-mode-switch') {
                $(".dark-light-switch #theme").prop('checked', true);
                $('body').attr('data-layout-mode', 'dark');
                $('body').attr('data-sidebar', 'dark');
                localStorage.setItem("is_visited", "dark-mode-switch");
                // updateThemeSetting(themeStyle);
            } else {
                $(".dark-light-switch #theme").prop('checked', false);
        ...
        $(".dark-light-switch #theme, #light-mode-switch, #dark-mode-switch, #rtl-mode-switch, #dark-rtl-mode-switch").on("change", function (e) {
